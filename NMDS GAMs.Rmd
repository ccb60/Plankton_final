...
4. Conduct GAM analyses of the synthetic NMDS axis scores, based on GAM models
   that follow the same model form as we used to analyze zooplankton abundance.
...
somewhat between repeated runs of the following code. The relatively high number of permutations specified here helps keep those effects small.
...
## Axis 2
This one converges readily, but only if I include the Season:Station interaction 
term..
```{r}
gam_2 <- gamm(MDS2 ~ 
               Station * 
