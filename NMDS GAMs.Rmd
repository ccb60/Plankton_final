...
4. Conduct GAM analyses of the NMDS axis scores, based on the FULL data.  This
   analysis includes both GAM models based on quantitative environmental
