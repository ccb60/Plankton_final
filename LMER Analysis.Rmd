...
Note that this model has four more parameters, and reduces the residual sums of 
...
## Reduced Model
Given the likely importance of key predictors, and the possibility of Simpson's
...
* Salinity matters, with higher fish abundance at higher salinities.  That may
  reflect the limits of the model for fitting very low salinity samples with a
  linear model.
...
* This Model suggests different environmental variables matter compared to the 
  GAM model.
