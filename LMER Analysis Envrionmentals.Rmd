...
# Introduction
This notebook reprises analyses using mixed model linear models instead of GAMs.  The goal is to lower complexity of models, and gain access to some tools for automated model selection.  
...
In this Notebook, I emphasize physical environmental variables.  The base model includes teh following Fixed Effects predictors:
...
*  Oxygen Saturation (Incomplete data and Highly colinear with Temperature),  
...
logic of applying consideration of colinearity is less confusing than the logic
...
The impact of the high leverage term is obvioous in a graphic.
...
model that retains Station as a fairly robust predictor, even though it was NOT identified as important in the full model.  Station is partially colinear with
