...
model that retains Station as a fairly robust predictor, even though it was NOT identified as important in the full model.  Station is partially collinear with
